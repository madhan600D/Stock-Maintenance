...
import {signUpUser , logInUser, LogOutUser , eMailConfirm , addUser , ValidateUser , GetLoadingTexts, EditProfile, LeaveOrg} from '../Controller/UserControllers/userCredentials.controller.js'
...
import { LeaveOrgValidate } from '../MiddleWares/EndPointValidations/UserEndPointValidations/Org.validate.js';
...
signUpRouter.post('/update-profile' , cookieValidation, EditProfile);
